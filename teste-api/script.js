...
// Global Constants
const API_URL = `${import.meta.env.VITE_AUTH_BASE_URL}/api/v1/servicos?page=0&size=5`;
...
async function carregarServicos(page = 0) {
    paginaAtual = page;
    const url = `${import.meta.env.VITE_AUTH_BASE_URL}/api/v1/servicos?page=${paginaAtual}&size=${TAMANHO_PAGINA}`;
